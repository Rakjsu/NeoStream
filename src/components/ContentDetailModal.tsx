            ...
            >
                ...
                <div style={narrow ? {
                    ...
                    <div style={narrow ? {
                        ...
                        {/* Loading */}
                        {loading && (
                            <div style={{ margin: 'auto', textAlign: 'center', color: 'rgba(255, 255, 255, 0.5)', fontSize: 13 }}>{t('contentModal', 'loadingEpisodes')}</div>
                        )}

                        {/* Error / retry */}
                        {!loading && loadError && (
                            <div style={{ margin: 'auto', textAlign: 'center', color: 'rgba(255, 255, 255, 0.7)', fontSize: 13 }}>
                                <p style={{ marginBottom: 12 }}>{t('contentModal', 'episodesLoadError')}</p>
