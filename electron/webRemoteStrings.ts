...
export const STRINGS: Record<RemoteLang, Record<string, string>> = {
    ...
    es: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep apagado', openApp: 'Traer la app al frente', zapNumPh: 'N\u00famero del canal', zapGo: 'Ir', zapNumMiss: 'Canal no encontrado', statsToday: 'hoy', statsWeek: '7 d\u00edas', themeToggle: 'Tema claro/oscuro', openMultiview: 'Multi-view en el PC', screenshotPc: 'Pantalla del PC', remindersTitle: 'Recordatorios', reminderCancel: 'Cancelar recordatorio',
