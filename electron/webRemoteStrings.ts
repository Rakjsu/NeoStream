...
export const STRINGS: Record<RemoteLang, Record<string, string>> = {
    pt: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep desligado', openApp: 'Trazer o app pra frente', zapNumPh: 'N\u00famero do canal', zapGo: 'Ir', zapNumMiss: 'Canal n\u00e3o encontrado', statsToday: 'hoje', statsWeek: '7 dias', themeToggle: 'Tema claro/escuro', openMultiview: 'Multi-view no PC', screenshotPc: 'Tela do PC', recRename: 'Renomear', recDownload: 'Baixar no celular', recRenamePrompt: 'Novo nome da grava\u00e7\u00e3o', recRenamed: 'Renomeada', recProtect: 'Proteger/desproteger', recProtected: 'Protegida contra exclus\u00e3o', recUnprotected: 'Desprotegida', trackpadHint: 'Trackpad: deslize = setas \u00b7 toque = OK', navBack: 'Voltar', remindersTitle: 'Lembretes', reminderCancel: 'Cancelar lembrete',
        ...
        castQueue: 'Transmitir fila', partyQueue: 'Fila da festa',
        ...
        guideTruncated: 'Mostrando {shown} de {total} canais. Os outros aparecem na busca \u{1F50D} do topo.',
        tuneFail: 'O computador n\u00e3o achou esse canal',
    ...
    en: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep off', openApp: 'Bring the app to front', zapNumPh: 'Channel number', zapGo: 'Go', zapNumMiss: 'Channel not found', statsToday: 'today', statsWeek: '7 days', themeToggle: 'Light/dark theme', openMultiview: 'Multi-view on PC', screenshotPc: 'PC screen', recRename: 'Rename', recDownload: 'Download to this device', recRenamePrompt: 'New recording name', recRenamed: 'Renamed', recProtect: 'Protect/unprotect', recProtected: 'Protected from deletion', recUnprotected: 'Unprotected', trackpadHint: 'Trackpad: swipe = arrows \u00b7 tap = OK', navBack: 'Back', remindersTitle: 'Reminders', reminderCancel: 'Cancel reminder',
        ...
        castQueue: 'Cast queue', partyQueue: 'Party queue',
        ...
        guideTruncated: 'Showing {shown} of {total} channels. The rest show up in the \u{1F50D} search at the top.',
        tuneFail: 'The computer could not find that channel',
    ...
    es: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep apagado', openApp: 'Traer la app al frente', zapNumPh: 'N\u00famero del canal', zapGo: 'Ir', zapNumMiss: 'Canal no encontrado', statsToday: 'hoy', statsWeek: '7 d\u00edas', themeToggle: 'Tema claro/oscuro', openMultiview: 'Multi-view en el PC', screenshotPc: 'Pantalla del PC', recRename: 'Renombrar', recDownload: 'Descargar en el móvil', recRenamePrompt: 'Nuevo nombre de la grabaci\u00f3n', recRenamed: 'Renombrada', recProtect: 'Proteger/desproteger', recProtected: 'Protegida contra borrado', recUnprotected: 'Desprotegida', trackpadHint: 'Trackpad: desliza = flechas \u00b7 toque = OK', navBack: 'Volver', remindersTitle: 'Recordatorios', reminderCancel: 'Cancelar recordatorio',
        ...
        castQueue: 'Transmitir cola', partyQueue: 'Cola de la fiesta',
        ...
        guideTruncated: 'Mostrando {shown} de {total} canales. Los dem\u00e1s aparecen en la b\u00fasqueda \u{1F50D} de arriba.',
        tuneFail: 'La computadora no encontr\u00f3 ese canal',
