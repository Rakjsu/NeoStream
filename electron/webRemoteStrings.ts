...
export const STRINGS: Record<RemoteLang, Record<string, string>> = {
    pt: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep desligado', openApp: 'Trazer o app pra frente', zapNumPh: 'N\u00famero do canal', zapGo: 'Ir', zapNumMiss: 'Canal n\u00e3o encontrado', statsToday: 'hoje', statsWeek: '7 dias',
    ...
    en: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep off', openApp: 'Bring the app to front', zapNumPh: 'Channel number', zapGo: 'Go', zapNumMiss: 'Channel not found', statsToday: 'today', statsWeek: '7 days',
    ...
    es: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep apagado', openApp: 'Traer la app al frente', zapNumPh: 'N\u00famero del canal', zapGo: 'Ir', zapNumMiss: 'Canal no encontrado', statsToday: 'hoy', statsWeek: '7 d\u00edas',
