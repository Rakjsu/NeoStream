...
export const STRINGS: Record<RemoteLang, Record<string, string>> = {
    pt: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep desligado', openApp: 'Trazer o app pra frente', zapNumPh: 'N\u00famero do canal', zapGo: 'Ir', zapNumMiss: 'Canal n\u00e3o encontrado', statsToday: 'hoje', statsWeek: '7 dias', themeToggle: 'Tema claro/escuro', openMultiview: 'Multi-view no PC', remindersTitle: 'Lembretes', reminderCancel: 'Cancelar lembrete',
    ...
    en: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep off', openApp: 'Bring the app to front', zapNumPh: 'Channel number', zapGo: 'Go', zapNumMiss: 'Channel not found', statsToday: 'today', statsWeek: '7 days', themeToggle: 'Light/dark theme', openMultiview: 'Multi-view on PC', remindersTitle: 'Reminders', reminderCancel: 'Cancel reminder',
    ...
    es: {
        ...
        sleepBtn: 'Sleep (min)', sleepOff: 'Sleep apagado', openApp: 'Traer la app al frente', zapNumPh: 'N\u00famero del canal', zapGo: 'Ir', zapNumMiss: 'Canal no encontrado', statsToday: 'hoy', statsWeek: '7 d\u00edas', themeToggle: 'Tema claro/oscuro', openMultiview: 'Multi-view en el PC', remindersTitle: 'Recordatorios', reminderCancel: 'Cancelar recordatorio',
