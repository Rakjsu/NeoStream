...
const sendChannels = new Set([
    ...
    'web-remote:progress',
    // 🔄 Reconciliação: estado de progresso daqui, pedido pelo celular ao
    // reconectar (o que o PC assistiu enquanto o link estava fora do ar).
    'web-remote:progress-snapshot',
